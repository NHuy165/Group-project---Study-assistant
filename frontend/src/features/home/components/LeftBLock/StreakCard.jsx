...
import robotPurple from "../../assets/robot-purple.png"; // Đổi sang .png
...
export const StreakCard = ({ dayCount = 3 }) => {
  ...
  const cardCls = isNight
    ...
    : "bg-gradient-to-br from-[#f5f3ff] to-white border-[#ede9fe] shadow-sm";

  return (
    <div className={`relative backdrop-blur-xl rounded-[2rem] p-4 border-2 w-full h-full flex flex-col items-center justify-center transition-all duration-500 text-center overflow-visible ${cardCls}`}>
      
      {/* Robot thụt vào vừa phải để không bị cắt xén */}
