          ...
          {ttrTasks &&
            ttrTasks.map((task) => (
              ...
              >
                ...
                <span
                  className={`text-sm font-semibold truncate ${task.status === "loading" ? "animate-pulse text-gray-500" : isNight ? "text-gray-200" : "text-purple-700"}`}
                >
                  {task.name}
                </span>
              </div>
              ...
              >
                ...
                <button
                  onClick={(e) => {
                    ...
                    if (
                      window.confirm(
                        "Bé có chắc chắn muốn xóa bài tập này không?",
                      )
                    ) {
