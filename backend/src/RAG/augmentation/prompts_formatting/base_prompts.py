...
- SUBJECT TYPE: If the document's contents in the `INPUT` section do not match the the subject type specified in the `Subject type` field, issue a very slight warning in the `summary` field of your output and perform the analysis as you would normally.
